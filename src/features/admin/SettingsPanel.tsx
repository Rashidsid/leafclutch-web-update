  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl border border-red-200 p-6 max-w-lg mt-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">Reset all services, testimonials and website images back to the original demo content. This cannot be undone.</p>
      ...
      {confirmReset && (
        <ConfirmDialog
          ...
          description="This replaces every service, testimonial and website image with the original demo data. Your admin password is not affected."
          confirmLabel="Reset"
