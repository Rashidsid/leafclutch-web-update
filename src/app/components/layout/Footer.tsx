...
const serviceLinks = [
  { label: 'Digital & Technology Solutions', to: '/services/digital-technology' },
...
export default function Footer() {
  return (
    <footer className="nepal-footer relative overflow-hidden border-t-4 border-[#0EA5EB] bg-linear-to-b from-[#0B1D36] to-[#062165]">
      <div className="nepal-footer-skyline absolute inset-x-0 bottom-full z-0 leading-none pointer-events-none select-none" aria-hidden="true">
        <svg viewBox="0 0 1440 190" preserveAspectRatio="none" className="w-full h-8 sm:h-12">
          <path d="M0 122 C145 88 245 137 380 104 C540 65 628 137 770 104 C930 67 1055 132 1190 96 C1300 67 1370 93 1440 78 L1440 190 L0 190Z" fill="#0EA5EB" opacity=".16" />
          <path d="M0 150 C180 121 288 160 430 133 C584 104 704 156 850 130 C1012 101 1134 157 1280 126 C1350 111 1404 119 1440 111 L1440 190 L0 190Z" fill="#0B1D36" />
          ...
          <g fill="#0B1D36">
            ...
            <path d="M690 143V124H708V143ZM732 143V124H750V143Z" fill="#edf7ff" opacity=".55" />
          </g>
          ...
          <g fill="#12B987">
            <path d="M274 60L286 65L275 72Z" /><path d="M326 59L314 65L325 72Z" />
            <path d="M980 55L992 60L981 67Z" /><path d="M1031 55L1019 60L1030 67Z" />
          </g>
          <g fill="#0EA5EB" opacity=".85"><circle cx="248" cy="55" r="3" /><circle cx="351" cy="43" r="4" /><circle cx="1144" cy="49" r="3" /><circle cx="1160" cy="66" r="4" /></g>
        </svg>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr_1.4fr_1fr] gap-6 pb-6 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-[#16D0AB] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@leafclutchtech.com.np" className="text-[#AEC0DE] text-sm hover:text-white transition-colors">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+9779766715768" className="text-[#AEC0DE] text-sm hover:text-white transition-colors">
                  +977-9766715768
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <span className="text-[#AEC0DE] text-sm">Siddharthanagar, Rupandehi</span>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {companyLinks.map((l) => (
                <li key={l.label}>
                  <Link href={l.to} className="text-[#AEC0DE] text-sm hover:text-white transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            <a href="#" className="text-[#AEC0DE] text-sm hover:text-white transition-colors">Privacy Policy</a>
            <a href="#" className="text-[#AEC0DE] text-sm hover:text-white transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
