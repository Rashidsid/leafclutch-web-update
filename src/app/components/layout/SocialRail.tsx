...
const socialLinks = [
  ...
  },
  {
    ...
    icon: <><rect x="3" y="6" width="18" height="12" rx="3" /><path d="M10 9l5 3-5 3V9z" fill="currentColor" stroke="none" /></>,
  },
  {
    name: 'Discord',
    href: 'https://discord.gg/4aDwcMZBPq',
    icon: <path d="M7.5 7.5A14 14 0 0112 6.8a14 14 0 014.5.7c1.3 1.8 2 4 2 6.5 0 2.2-1.1 3.7-3.1 4.7l-1.1-1.5M7.5 7.5a12 12 0 00-2 6.5c0 2.2 1.1 3.7 3.1 4.7l1.1-1.5M7.5 7.5c.8 1 1.4 2.2 1.7 3.5M16.5 7.5a12 12 0 00-1.7 3.5M9 14.5h.01M15 14.5h.01M9.5 16.5c1.5.7 2.5.7 5 0" />,
  },
]
...
export default function SocialRail() {
  ...
  return (
    <>
      ...
      <button type="button" onClick={scrollToTop} aria-label="Scroll to top" className="social-scroll-link hidden select-none z-60 fixed bottom-10 left-0 w-18 flex-col items-center gap-2 text-[10px] uppercase tracking-[0.28em] text-[#676F7E] transition-colors hover:text-[#0EA5E9] md:flex">
